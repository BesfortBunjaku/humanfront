...
function FirstNamePage(props) {
  ...
  const upload = (file) => {
    fetch('http://127.0.0.1:8000/api/upload/', { // Your POST endpoint
      method: 'POST',
      headers: {
        "Accept": "application/json",
        // Content-Type may need to be completely **omitted**
        // or you may need something
        "Content-Type": "multipart/form-data; boundary=----WebKitFormBoundaryYuFNsWbzela9EzOm"
      },
